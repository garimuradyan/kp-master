...
(function(){
  ...
  function docStyles(color){
    return '<style>'+ 
      ...
      '@media(max-width:640px){body{padding:10px}.doc-page{padding:22px 16px;border-radius:8px}.doc-title{font-size:15px}th,td{font-size:9.5px;padding:5px 4px}th:nth-child(3),td:nth-child(3),th:nth-child(6),td:nth-child(6){width:68px}th:nth-child(4),td:nth-child(4){width:36px}th:nth-child(5),td:nth-child(5){width:38px}.doc-sign-grid{grid-template-columns:1fr;gap:14px}.doc-topline{flex-direction:column;gap:2px}}'+
